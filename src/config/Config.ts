const markdownConfig: IConfig = {
  ...
  elements: [
    ...
    { id: '11', element: 'Link', syntax: '[title](https://www.example.com)' },
    ...
    { id: '18', element: 'Strikethrough', syntax: '~~The world is flat.~~' },
    {
      id: '19',
      element: 'Task List',
      syntax:
    ...
    { id: '24', element: 'Inline HTML', syntax: '<strong>bold text</strong>' },
    {
      id: '25',
    ...
    { id: '30', element: 'Mathematics (MathJax)', syntax: '$$ E = mc^2 $$' },
    {
      id: '31',
